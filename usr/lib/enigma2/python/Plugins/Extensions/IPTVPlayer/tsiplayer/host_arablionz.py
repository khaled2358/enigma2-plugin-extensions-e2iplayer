...
def getinfo():
	info_={}
	info_['name']='Arblionz.Com'
	info_['version']='1.2 24/05/2019'
	info_['dev']='RGYSoft'
	info_['cat_id']='201'
	info_['desc']='أفلام و مسلسلات عربية و اجنبية'
	info_['icon']='https://i.ibb.co/16pJgMF/unnamed.jpg'
	info_['recherche_all']='1'
	info_['update']='reFix Serie Category + Change host to hd.arablionz.com'	

	return info_
	
def getfiltre():
	filtre_=[]
	filtre_.append(( 101,{'url':'https://tv.arblionz.com/category/%D8%A7%D9%81%D9%84%D8%A7%D9%85-%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9/'            ,'sub_mode':'items','mode':'30'}))
	filtre_.append(( 201,{'url':'https://tv.arblionz.com/category/%D9%85%D8%B3%D9%84%D8%B3%D9%84%D8%A7%D8%AA-%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9/','sub_mode':'items','mode':'30'}))
	filtre_.append(( 211,{'url':'https://tv.arblionz.com/category/%D9%85%D8%B3%D9%84%D8%B3%D9%84%D8%A7%D8%AA-%D8%B1%D9%85%D8%B6%D8%A7%D9%86-/','sub_mode':'items','mode':'30'}))
	return filtre_	
...
class TSIPHost(TSCBaseHostClass):
	def __init__(self):
		...
		self.MAIN_URL = 'https://hd.arblionz.com'
	...
	def showmenu2(self,cItem):		
		...
		cat_serie_data=re.findall('href="/cat/مسلسلات">(.*?)<li><a href="https://...arblionz.com/category/برامج-تليفزيونية/"', data, re.S) 
		cat_music_data=re.findall('arblionz.com/category/اغاني-وكليبات/">(.*?)</ul>', data, re.S) 
		if gnr=='film': 
	...
	def getArticle(self, cItem):
		...
		otherInfo1 = {}
		sts, data = self.akoam_getPage(cItem['url'])
