...
def getinfo():
	info_={}
	info_['name']='Shahid4u.Net'
	info_['version']='1.0 4/06/2019'
	info_['dev']='Opesboy'
	info_['cat_id']='201'
	info_['desc']='أفلام و مسلسلات عربية و اجنبية'
	info_['icon']='https://eg.shahid4u.net/themes/Shahid4u/img/logo.png'
...
class TSIPHost(TSCBaseHostClass):
	def __init__(self):
		...
		self.MAIN_URL = 'https://eg.shahid4u.net'
